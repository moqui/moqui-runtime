...
<div class="tab-content">
    <div id="login" class="tab-pane active">
        <form method="post" action="${sri.buildUrl("login").url}" class="form-signin" id="login_form">
            ...
            <input type="text" name="username" value="${(ec.getWeb().getErrorParameters().get("username"))!""}" placeholder="${ec.l10n.localize("Username")}" required="required" autocomplete="off" class="form-control top" id="login_form_username">
            <input type="password" name="password" placeholder="${ec.l10n.localize("Password")}" required="required" autocomplete="off" class="form-control bottom">
    ...
    <div id="reset" class="tab-pane">
        <form method="post" action="${sri.buildUrl("resetPassword").url}" class="form-signin" id="reset_form">
            ...
            <input type="text" name="username" placeholder="${ec.l10n.localize("Username")}" required="required" autocomplete="off" class="form-control">
    ...
    <div id="change" class="tab-pane">
        <form method="post" action="${sri.buildUrl("changePassword").url}" class="form-signin" id="change_form">
            ...
            <input type="hidden" name="moquiSessionToken" value="${ec.web.sessionToken}">
            <input type="text" name="username" value="${(ec.getWeb().getErrorParameters().get("username"))!""}" placeholder="${ec.l10n.localize("Username")}" required="required" autocomplete="off" class="form-control top">
            <input type="password" name="oldPassword" placeholder="${ec.l10n.localize("Old Password")}" required="required" autocomplete="off" class="form-control middle">
            <input type="password" name="newPassword" placeholder="${ec.l10n.localize("New Password")}" required="required" autocomplete="off" class="form-control middle">
            <input type="password" name="newPasswordVerify" placeholder="${ec.l10n.localize("New Password Verify")}" required="required" autocomplete="off" class="form-control bottom">
