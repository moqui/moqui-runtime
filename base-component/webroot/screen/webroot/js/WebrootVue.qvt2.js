...
moqui.webrootVue.component('m-menu-tree', {
    ...
    methods: {
        getMenuNodes: function() {
            ...
            if ( this.$root.navMenuList &&  this.$root.navMenuList.length ) {
                nds = [ this.$root.navMenuList[0] ];
                if (this.$root.navMenuList[1] &&  this.$root.navMenuList[1].subscreens && this.$root.navMenuList[1].subscreens.length  ) {
                    this.buildSubscreens(this.$root.navMenuList[0], 1 );
                } else if (this.$root.navMenuList[1] &&  this.$root.navMenuList[1].savedFinds && this.$root.navMenuList[1].savedFinds.length  ) {
                    this.buildSavedFinds(this.$root.navMenuList[0]);
                } else {
                    this.buildSubscreens(this.$root.navMenuList[0], 1 );
                }
            }
        ...
        buildSavedFinds: function(parentScreen) {
            parentSubscreen.subscreens = parentSubscreen.savedFinds;
            return;
        },
        go: function go() { this.$root.setUrl(this.navMenuItem.pathWithParams); },
        goPath: function goPath(path) { this.$root.setUrl(path); }
