...
/* TODO:
 - change Login.xml CreateInitialAdminAccount to inline html, form-single (using m-form) won't work here without Vue, etc
 - in form-list saved forms make sure list updates on new and delete
 - need something like n-form variation on m-form for navigation forms like searching, links, etc
   - change link to use n-form instead of m-form
   - fix form-list find options, go page, etc to make sure parameters are passed through and page reloads
 - fix form-single and form-list submit page not reloading
 ...
 - add fully client rendered version of form-list when it has data prep embedded
   ...
   - add form-list.rest-entity, rest-service, and maybe service-call/actions/etc
...
Vue.component('m-form', {
    ...
    methods: {
        ...
        submitForm: function submitForm() {
            var jqEl = $(this.$el); if (this.noValidate || jqEl.valid()) { jqEl.ajaxSubmit({ resetForm:false, type:this.method, url:this.action,
...
Vue.component('drop-down', {
    ...
    methods: {
        populateFromUrl: function() {
            ...
            var vm = this; $.ajax({ type:"POST", url:this.optionsUrl, data:reqData, dataType:"json", success: function(list) { if (list) {
