...
/* TODO:
 ...
 - m-form
   - anything special to handle upload fields? (isUpload)
   - get button pressed and pass parameter, formSerialize() and ajaxSubmit() don't seem to do that
...
Vue.component('m-form', {
    ...
    methods: {
        ...
        submitForm: function submitForm() {
            ...
            console.log('m-form parameters ' + jqEl.formSerialize());
            // TODO: get button pressed and pass parameter, formSerialize() and ajaxSubmit() don't seem to do that
            if (this.noValidate || jqEl.valid()) { jqEl.ajaxSubmit({ resetForm:false, type:this.method, url:this.action,
                data:otherParms, headers:{Accept:'application/json'}, success:this.handleResponse }); }
        },
