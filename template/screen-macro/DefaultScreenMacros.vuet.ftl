...
<#macro "container-box">
    ...
    <container-box<#if contBoxDivId?has_content> id="${contBoxDivId}"</#if> type="${.node["@type"]!"default"}"<#if boxHeader?has_content> title="${ec.getResource().expand(boxHeader["@title"]!"", "")}"</#if> :initial-open="<#if ec.getResource().expand(.node["@initial"]!, "") == "closed">false<#else>true</#if>">
        ...
        <#if boxHeader?has_content><template slot="header"><#recurse boxHeader></template></#if>
